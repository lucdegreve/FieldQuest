...
<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-6">
				<div class="card text-white bg-secondary mb-3" style="border-radius: 10px 10px; color: gray">
                        ...
                        echo '<div class="container-fluid">';
                        	echo '<div class="row">';
           						...
           						echo '<div class="col-md-6">';
                        			...
                        			echo 'Start date : '.'<button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="'.$start_date.'">'.$start_date.'</button>';
                        			echo '</div></div>'; 
                        		echo '</div>';
                        		echo '<div class="col-md-3"></div>';
                        	echo '</div>';
                	...
                	if ($_POST['end']!=''){
                        ...
                        echo '<div class="container-fluid">';
                        	echo '<div class="row">';
           						...
           						echo '<div class="col-md-6">';
                        			echo '<div class="card text-white bg-primary mb-3" style="border-radius: 20px 50px"><div class="card-body">';
                        			echo 'End date : '.'<button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="'.$end_date.'">'.$end_date.'</button>';
                        			echo '</div></div>'; 
                        		echo '</div>';
                        		echo '<div class="col-md-3"></div>';
                        	echo '</div>';
                        	...
                        	echo '<div class="row">';
           						...
           						echo '<div class="col-md-6">';
                        			echo '<div class="card text-white bg-primary mb-3" style="border-radius: 20px 50px"><div class="card-body">';
                        				echo 'Format(s) :';
                        			foreach($format as $i){
                        				echo '<button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="'.$i.'">'.$i.'</button>';
                        			}
                        			echo '</div></div>';  
                        		echo '</div>';
                        	echo '<div class="col-md-3"></div>';
