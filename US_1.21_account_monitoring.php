	...
	<div class='container'> 
        ...
        // You have to update the database and to re pre-fill the form to have a view
            ...
            if (isset($_GET["last_name"],$_GET["first_name"])){
				...
				echo "<div class='alert alert-success'> The user's information has been updated </div>";
	...
	?>
		<!--//Then present all the info properly in a table-->
			...
			<div class="input-group mb-3">
				...
				<input type="text" size = "50" name="last_name" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" value="<?php echo $row[0]; ?> ">
			</div>
			<div class="input-group mb-3">
				<div class="input-group-prepend">
				...
				<input type="text" size = "50" name="first_name" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" value="<?php echo $row[1]; ?>">
			</div>
			<div class="input-group mb-3">
			  <div class="input-group-prepend">
			...
			<input type="text" size = "50" name="company" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" value="<?php echo $row[2]; ?>">
			</div>
			<div class="input-group mb-3">
				<div class="input-group-prepend">
				...
				<input type="text" size = "50" name="address" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" value="<?php echo $row[3]; ?>">
			</div>
			<div class="input-group mb-3">
				<div class="input-group-prepend">
				...
				<input type="text" size = "50" name="postcode" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" value="<?php echo $row[4]; ?>">
			</div>
			<div class="input-group mb-3">
				<div class="input-group-prepend">
				...
				<input type="text" size = "50" name="city" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" value="<?php echo $row[5]; ?>">
			</div>
			<div class="input-group mb-3">
				<div class="input-group-prepend">
				...
				<input type="text" size = "50" name="country" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" value="<?php echo $row[6]; ?>">
			</div>
			<div class="input-group mb-3">
				<div class="input-group-prepend">
				...
				<input type="text" size = "50" name="email" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" value="<?php echo $row[7]; ?>">
			</div>
			<div class="input-group mb-3">
				<div class="input-group-prepend">
				...
				<input type="text" size = "50" name="phone" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" value="<?php echo $row[8]; ?>">
			</div>
			<div class="input-group mb-3">
				<div class="input-group-prepend">
				...
				<input type="text" size = "50" name="website" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" value="<?php echo $row[9]; ?>">
			</div>
			<input type="hidden" size = "50" name="id_user_account" value="<?php echo $id_user_account; ?>">
	  ...
	  echo'<div id="associated_projects_before" class= "col-md-6">';
		  echo '<table>';
			  for ($i=0; $i < $nb_rows ; $i++) {
				echo '<tr>';
					echo '<td> Projet '.$tab_associated_project[$i][0].' : '.$tab_associated_project[$i][1].' </td> 
					<td> <button type="button" name="delete_project" class= "btn btn-outline-danger" onclick=deleteproject1('.$tab_associated_project[$i][0].')>Delete </button></td>';
				echo '</tr>';
			  }
		  echo '</table>';
	  echo '</div>';
	  ...
	  echo '</div>'; // end div list-projects-a
